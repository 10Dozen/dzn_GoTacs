dzn_GoTacs_fnc_ShowAdvDialog = {
	...
	*/
...

	{
		...
		private _lineProperties = [_line, _type, _data, _textParams, _tileParams, _expression, _widthMultiplier, [_args, ["STRING"]] call dzn_GoTacs_fnc_stringify];
